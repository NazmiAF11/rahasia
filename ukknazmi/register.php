                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form action="proses/proses_register.php" class="user" method="post">
                            <?php
      if(isset($error)){
      ...
      ?>
                             <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="level" class="form-control form-control-user" id="exampleInputnama" placeholder="Masukan level Anda..." name="level"required>
                                    </div>
                                ...
                                <hr>
                                <a href="admin/admin.php" class="btn btn-google btn-user btn-block">
