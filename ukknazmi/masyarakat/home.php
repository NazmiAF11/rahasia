  ...
  <tbody>
    <tr class="text-center">
      ...
      <td>
        ...
        <a href="../delete.php?id_pengaduan=<?=$row['id_pengaduan'];?>" class="btn btn-warning"><ion-icon name="close-circle-outline"></ion-icon>Delete</a>
        <a href="../detail.php?id_pengaduan=<?=$row['id_pengaduan'];?>" class="btn btn-danger">Detail</a>
      </td>
    </tr>
    </tbody>
    <?php $i++; ?>
