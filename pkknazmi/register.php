...
<head>
    ...
    <title>pengaduan_masyarakat - Register</title>
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="post" action="proses_register.php">
                                ...
                                <div class="form-group">
                                        <input type="password" class="form-control form-control-user" id="exampleInputnama" placeholder="Masukan password Anda...">
                                    </div>
                                <a href="login.php" class="btn btn-primary btn-user btn-block">
                                    Register Account
                                </a>
                                <hr>
                                <a href=".php" class="btn btn-google btn-user btn-block">
                                    <i class="fab fa-google fa-fw"></i> Register with Google
                                </a>
                                <a href=".php" class="btn btn-facebook btn-user btn-block">
